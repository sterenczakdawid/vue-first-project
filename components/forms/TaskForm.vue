...
export default {
  ...
  computed: {
    apps() {
      console.log("wywoluje getter app do store z taskform.vue");
      return this.$store.getters["modules/apps/apps"];
    },
    tasks() {
      console.log("wywoluje getter taskow do store z taskform.vue");
    ...
    servers() {
      console.log("wywoluje getter serverow do store z taskform.vue");
